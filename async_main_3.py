        ...
        if price_sell > max_bid_value and price_buy < min_ask_value:
            ...
            if network_buy == "Ethereum" or network_sell == "Ethereum":
                if percents_spread >= 15:
                    ...
                    print(f"**********SIGNAL**********")
                    print(signal_output)
                    with open('results/async_signals_3.txt', 'a') as file:
            ...
            with open('results/async_results_3.txt', 'a') as file:
...
async def main():
    coins_info = json.load(open("tokens_coins_info/coins_info_3.json"))
